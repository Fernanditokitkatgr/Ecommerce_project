...
class EcommerceDataLoader:
    ...
    def clean_order_items_data(self) -> pd.DataFrame:
        ...
        order_items['total_item_value'] = order_items['price'] + \
    ...
    def create_sales_dataset(self, year_filter: Optional[int] = None,
        ...
        if status_filter:
            sales_data = sales_data[sales_data['order_status']
                                    == status_filter]
        ...
        if month_filter:
            sales_data = sales_data[sales_data['purchase_month']
                                    == month_filter]
        ...
        if 'customers' in self.raw_data and 'customer_id' in sales_data.columns:
            sales_data = sales_data.merge(
                self.raw_data['customers'][['customer_id',
